...
jQuery( document ).ready( function( e ) {
	...
	jQuery( this ).on( 'change', '.kong-container input[type="text"]', function( e ) {
    ...
    jQuery( this ).on( 'click', '#add-expression', function( e ) {
    	e.preventDefault();
	    ...
	    jQuery( '#show-on' ).append( `<select name="" id="">
          <option>Show on', 'kong-popup' ); ?></option>
        </select>` );
	...
	jQuery(document).on('click', '.removeSection', function() {
...
var welcomePageFld = function(title, id) {
...
var radioButtonFld = function(title, id) {
  return `<div class="drugableSection" id="${id}">
    <div class="pt-addfield-box">
      <div class="accrodianBtn">
        <span class="pt-addfield-box-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
...
var singleLineTextFld = function (title, id) {
  return `<div class="drugableSection" id="${id}">
    <div class="pt-addfield-box">
      <div class="accrodianBtn">
        <span class="pt-addfield-box-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
...
var successPageFld = function(title, id) {
  return `<div class="drugableSection" id="${id}">
    <div class="pt-addfield-box">
      <div class="accrodianBtn">
        <span class="pt-addfield-box-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
...
var ratingFld = function (title, id) {
  return `<div class="drugableSection" id="${id}">
  <div class="pt-addfield-box">
    <div class="accrodianBtn">
      <span class="pt-addfield-box-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
...
var newSegment = function(title, id) {
  return `<div class="drugableSection" id="${id}">
  <div class="pt-addfield-box">
      <div class="accrodianBtn">
          <span class="pt-addfield-box-icon"><i class="fa fa-bars" aria-hidden="true"></i></span>
