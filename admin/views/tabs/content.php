  ...
  <div class="w-50 left-panel">
    ...
    <div class="form-wrap">
        ...
        if ( in_array( $slug, array( 'spin-wheel' ) ) ) {
            ...
            <label for="bottom-right" class="pos-label <?php if ( isset( $popup_meta[ 'content_position' ] ) && trim( $popup_meta[ 'content_position' ] ) == 'bottom-right' ) echo 'selected'; ?>">
        ...
        <!-- .pt-addfield starts -->
        <div class="pt-addfield" id="fldArea"></div>
        <!-- .pt-addfield ends -->
